...
def reverse_characters(string_to_reverse):
    listed_string = list(string_to_reverse)
    listed_string.reverse()
    reversed_string = "".join(listed_string)
    return reversed_string

print(reverse_characters("Happy Thanksgiving!"))
...
def reverse_list(list_to_change):
    newlist = []
    for index in list_to_change:
        reversed_item = reverse_characters2(index)
        newlist.append(reversed_item)
    return newlist
